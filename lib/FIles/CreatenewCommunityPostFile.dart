...
class CreatenewCommunityPostFile extends StatefulWidget
{
  final headercommunityid;
  const CreatenewCommunityPostFile({Key key,this.headercommunityid}):super(key:key);
  ...
  State<StatefulWidget> createState() {
    ...
    return _CreatenewCommunityPostFileState();
  }
}
class _CreatenewCommunityPostFileState extends State<CreatenewCommunityPostFile> with TickerProviderStateMixin,ImagePickerListener {
  ...
  void _uploaddatafirestore() async {
    try{
      ...
      await Firestore.instance.collection("communitiesitem").add({
        ...
        Firestore.instance.collection("communities").document(widget.headercommunityid).updateData({"communitiyposts":FieldValue.arrayUnion([documentReference.documentID])}).then((data){
