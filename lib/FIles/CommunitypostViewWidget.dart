...
import 'UserShowProfile.dart';

class CommunitypostViewWidget extends StatefulWidget{
  final List<CommunityListDetailFileModels> newsfeedlist;
  const CommunitypostViewWidget({Key key,this.newsfeedlist}):super(key:key);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _CommunitypostViewWidgetstate();
  }
}
class _CommunitypostViewWidgetstate extends State<CommunitypostViewWidget>{
  @override
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    [
                      ...
                      Column(mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: <Widget>[
                          Padding(padding: EdgeInsets.only(left: 20),
                            child:
                            Text(widget.newsfeedlist[index].communitytitle,
                              style: TextStyle(
                                  color: Colors.black,
                          ...
                          Padding(padding: EdgeInsets.only(left: 20, right: 5),
                              child: Row(children: <Widget>[
                                Expanded(child: Text(
                                  widget.newsfeedlist[index].communitysubtitle,
                                  style: TextStyle(
                                      color: MyColors.lightgrey, fontSize: 14
                                  ),
                                  textAlign: TextAlign.left,)),
                                Text(UiViewsWidget.timesagofeacture(
                                    widget.newsfeedlist[index].communityposttime),
                                  style: TextStyle(
                                      color: MyColors.lightgrey, fontSize: 14
                                  ),
                                  textAlign: TextAlign.left,),
                      ...
                      FadeInImage(
                        ...
                        fit: BoxFit.fill,
                        image: NetworkImage(
                            widget.newsfeedlist[index].communityimage),
  ...
  void _likesstatechange(CommunityListDetailFileModels newsfeedlist)
  {
...
//// updatedislikeonfirebase
  ...
  void _dislikesstatechange(CommunityListDetailFileModels newsfeedlist)
  {
...
///// updatedislikeonfirebase
  ...
  void _bookmarkstatechange(CommunityListDetailFileModels newsfeedlist)
  {
  ...
  void updatelikeonfirebase(bool param0,CommunityListDetailFileModels newsfeedlist)
  {
    ...
    try {
      if (param0 == true) {
        ...
        Firestore.instance.collection('communitiesitem')
            .document(newsfeedlist.communitysid)
            .updateData(map);
      }
      else {
        Map<String, dynamic> map = {
  ...
  void updatedislikeonfirebase(bool param0,CommunityListDetailFileModels newsfeedlist)
  {
    String userid=PrefrencesManager.getString(Stringconstants.USERID);
    try {
      if (param0 == true) {
  ...
  void updatebookmarkonfirebase(bool param0, CommunityListDetailFileModels newsfeedlist)
  {
    String userid=PrefrencesManager.getString(Stringconstants.USERID);
    try {
      if (param0 == true)
      {
        ...
        Map<String, dynamic> maps = {
          "bookmarkslist": FieldValue.arrayUnion([{"id":newsfeedlist.communitysid,
            "date":UiViewsWidget.getcurrentdateasrequireformat("DD MMM yyyy"),
            "cat":"Community",
            "title":newsfeedlist.communitytitle,
            "img":newsfeedlist.communityimage
          }])
      ...
      else
      {
        ...
        item['id'] == newsfeedlist.newsid;
            ...
            for(int i=0;i<newbookmarklist.length;i++){
              ...
              if(mapss['id']==newsfeedlist.communitysid){
  ...
  void _returnwithdetaildialogbox(CommunityListDetailFileModels newsfeedlist)
  {
            ...
            SingleChildScrollView(
                ...
                Container(margin: EdgeInsets.only(top: 0,bottom: 0,left: 0,right: 0), padding: EdgeInsets.only(top: 10,bottom: 10,left: 5,right: 5), decoration:  BoxDecoration(color: MyColors.basetextcolor,
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
                    SizedBox(height: 15,),
                    Text(newsfeedlist.communitytitle,
                    ...
                    FadeInImage(
                      ...
                      fit: BoxFit.fill,
                      image: NetworkImage(newsfeedlist.communityimage), placeholder: AssetImage(ConstantsForImages.imgplaceholder),),
